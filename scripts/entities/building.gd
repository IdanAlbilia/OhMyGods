...
const PNG_BUILDINGS := {
	"temple":             "res://assets/buildings/Comp6.png",
	"generals_quarters":  "res://assets/characters/marcus/Marcus Habitat.png",
	"shelter":            "res://assets/buildings/Comp1.png",
	"hall_of_devoted":    "res://assets/buildings/Comp5.png",
	"preacher_shelter":   "res://assets/buildings/Comp2.png",
	"armory":             "res://assets/buildings/Comp4.png",
	"garrison":           "res://assets/buildings/Comp3.png",
	"well":               "res://assets/buildings/Comp8.png",
	"garden":             "res://assets/buildings/Comp7.png",
	"stone_pool":         "res://assets/buildings/Comp10.png",
}
